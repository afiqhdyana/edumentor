...
//Route::get('/notice', [NoticeController::class, 'showForm'])->name('notice.form');
//Route::post('/notice', [NoticeController::class, 'create'])->name('notice.create');
//Route::middleware(['auth'])->group(function () {
    // Existing routes for personal advisor actions

    // Add the route for displaying notices
    //Route::get('/notices', [NoticeController::class, 'index'])->name('notices.index');
    Route::get('/notices', [NoticeController::class, 'index'])->name('notices.index');

    // Route for receiving notices (both sent and received)
    Route::get('/notices/receive', [NoticeController::class, 'receiveNotices'])->name('notices.receive');
    
    // Route for showing the send notice form
    Route::get('/notices/send', [NoticeController::class, 'showSendForm'])->name('notices.send');
    
    // Route for handling the notice sending (form submission)
    Route::post('/notices/send', [NoticeController::class, 'sendNotice'])->name('notices.send');
    // Other routes for personal advisor actions, if any
//});
...
Route::post('/attendance', [AttendanceController::class, 'viewStudents'])->name('attendance.viewStudents');
Route::post('/attendance/store', [AttendanceController::class, 'store'])->name('attendance.store');
// routes/web.php

// routes/web.php

//Route::any('/attendance', 'AttendanceController@index')->name('attendance.index');
...
Route::post('/update-role', [StudentController::class, 'updateRole'])->name('update-role');
...
Route::get('/studPerformancess', [StudentController::class, 'showPerformance'])->name('showPerformance');
