                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a class="btn btn-primary" role="button" href="studProfile/{{ $stud->matricNo }}">View Profile</a>
                    </td>
                    <td class="text-center">
                      <a class="btn btn-primary" role="button" href="/studInfo/resultMore/{{ $stud->matricNo }}">View Result</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
