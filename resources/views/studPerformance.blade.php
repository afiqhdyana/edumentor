...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="height: 773px;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-icon rotate-n-15"><i class="fas fa-laugh-wink"></i></div>
                    <div class="sidebar-brand-text mx-3"><span>SMADVISORY</span></div>
                </a>
                <hr class="sidebar-divider my-0">
                <ul class="navbar-nav text-light" id="accordionSidebar-2">
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link" href="StuInfo.html"><span><i class="fas fa-user"></i>Student Info</span>
                            <ul>
                                <li>Profile</li>
                                <li><span>Result</span></li>
                                <li><span>Credit Transfer</span></li>
                            </ul>
                        </a><a class="nav-link active" href="stuPerformance.html"><i class="fas fa-user-circle"></i><span>Student Performance</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="couRecommender.html"><i class="fas fa-table"></i><span>Course Recommender</span></a><a class="nav-link"><i class="far fa-user-circle"></i><span>Student Performance</span></a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
                <ul class="list-group">
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="height: 1px;">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="badge bg-danger badge-counter">3+</span><i class="fas fa-bell fa-fw"></i></a>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="dropdown"><button class="btn btn-primary dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button" style="width: 250px;">Student Name</button>
                            <div class="dropdown-menu"><a class="dropdown-item" href="#">First Item</a><a class="dropdown-item" href="#">Second Item</a><a class="dropdown-item" href="#">Third Item</a></div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Student Skills</h6>
                                    <div class="dropdown no-arrow"><button class="btn btn-link btn-sm dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button"><i class="fas fa-ellipsis-v text-gray-400"></i></button>
                                        <div class="dropdown-menu shadow dropdown-menu-end animated--fade-in">
                                            <p class="text-center dropdown-header">dropdown header:</p><a class="dropdown-item" href="#">&nbsp;Action</a><a class="dropdown-item" href="#">&nbsp;Another action</a>
                                            <div class="dropdown-divider"></div><a class="dropdown-item" href="#">&nbsp;Something else here</a>
...
var options = {
  ...
  series: [
    {
      name: "Radar Series 1",
      data: [23, 52, 38, 24, 33, 10, 23, 24, 25] 
    }
   
  ],
  labels: ['GK','CSK','CT','PS','LLL','TW','CS','TSK','CRT','IM']
}
...
<script>
    ...
    var chartz = new ApexCharts(document.querySelector("#chart2"), options3);
