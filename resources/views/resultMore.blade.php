...
<body>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
                    ...
                    @foreach ($result as $results)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-primary" role="button" href="/moremoreResults?matricNo={{ $stud->matricNo }}&semester={{ $results->semester }}">View</a>
                            </td>
            ...
            <br>
            <td class="center">
            <a class="btn btn-primary " role="button" href="/studInfo" style="font-size: smaller;">Back</a>
          </td>
        </div>
    </div>
</main>
